                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" name="Condiciones" value="SI">Acepto los Tèrminos y Condiciones.
                                                </label>
                                            </div>
                                        </div>

                                        <button type="submit" class="btn btn-default" value="Registrar" 
                                                name="BotonRegistrar" >Registrarme</button>
