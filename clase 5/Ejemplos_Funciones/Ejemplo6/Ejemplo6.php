...
function Incentivo($CantidadHorasExtra,$Sueldo){
    $resultadoi=0;
    if($CantidadHorasExtra>=5){
        $resultadoi= (($Sueldo*10) /100);
    }
    

    elseif ($CantidadHorasExtra<5){
        $resultadoi= (($Sueldo*5) /100);
    }
    return $resultadoi;
}
                            ...
                            <tbody>
                                ...
                                for ($i = 0; $i < $CantidadPersonas; $i++) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <strong>
                                                $ <?php $resultadoi= Incentivo( $Personas[$i]['Horas_Extras'], $Personas[$i]['Sueldo']); ?> 
                                                <?php echo $resultadoi; ?> 
                                            </strong>
                                        </td>
                                       <td>
                                            <strong>
                                                $ <?php echo Calcular_SueldoFinal($Personas[$i]['Sueldo'], $Monto_Cobrar_HsExtra + $resultadoi); ?> 
                                            </strong>
                                        </td>
